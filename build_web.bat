...
odin build source\main_web -target:js_wasm32 -build-mode:obj -define:RAYLIB_WASM_LIB=env.o -define:RAYGUI_WASM_LIB=env.o  -out:%OUT_DIR%\game.o
...
copy %ODIN_PATH%\core\sys\wasm\js\odin.js %OUT_DIR%\odin.js
